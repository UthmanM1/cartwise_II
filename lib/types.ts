...
// Single source of truth for valid category slugs — used to derive the
// CategorySlug union type below and imported by lib/validation/schemas.ts
// so the search API validates against the same set at runtime.
